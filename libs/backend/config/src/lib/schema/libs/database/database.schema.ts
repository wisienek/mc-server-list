...
export const DatabaseSchema = z.object({
    DB_HOST: z
        .string()
        .min(4, 'DB_HOST must be at least 3 characters long')
        .default('localhost'),
    DB_PORT: z.coerce
        .number()
    ...
    DB_USERNAME: z
        .string()
        .min(3, 'DB_USERNAME cannot be empty and minimum of 3 characters!'),
    DB_DATABASE: z
        .string()
        .min(3, 'DB_DATABASE cannot be empty and minimum of 3 characters!'),
